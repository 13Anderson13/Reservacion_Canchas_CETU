...
@XmlRootElement(name = "MostrarHistorialReservas")
public class MostrarHistorialReservas {

    @XmlElementRef(name = "estadoReserva", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
