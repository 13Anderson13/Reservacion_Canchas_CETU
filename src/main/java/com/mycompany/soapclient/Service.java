 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:58737/Service.svc?wsdl")
    ...
    extends jakarta.xml.ws.Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:58737/Service.svc?wsdl");
